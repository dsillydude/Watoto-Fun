...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 font-sans transition-colors duration-500 overflow-x-hidden w-full py-8 px-4 sm:px-6 lg:px-8">
      {/* Main Container with rounded corners and shadow */}
      <div className="max-w-7xl mx-auto bg-white dark:bg-gray-800 rounded-[1.5rem] shadow-soft p-6 sm:p-8 lg:p-10 transition-all duration-300 hover:shadow-soft-hover overflow-hidden">
        {/* Header */}
